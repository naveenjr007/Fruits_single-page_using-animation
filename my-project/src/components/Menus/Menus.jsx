                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6'>
                    {MenuData.map((menu) => (
                        <motion.div
                            ...
                            key={menu.id} className='bg-white rounded-3xl px-4 py-2 shadow-[0_0_22px_0_rgba(0,0,0,0.15)] 
                        flex justify-around items-center gap-3'>
                            <img
                                src={menu.img}
                                alt={menu.title}
                                className='w-20 mb-4 mx-auto scale-110 transform-translate-y-6'
                            />
                            <div>
